...
<body>
        <nav class="navbar navbar-expand-lg sticky-top d-flex">
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive"> <span class="navbar-toggler-icon"><i class="fa-solid fa-bars"></i></span>
                </button>
        ...
        <input type="button" class="dbtn2 dbtn" value="Download app" title="App is in developing stage">    
        </div>
        <!-- <//////////////////////ABOUT SECTION/////////////////////////////> -->
    ...
    <!-- <!-==================================Become a partner==========================-!> -->
            <form action="index.php" method="POST" class="jumbotron container" id="partner">
                ...
                <input type="text" class="bcinput" name="restaurant" placeholder="Enter your restaruant name"> <br><br>
                <input type="text" class="bcinput" name="userName" placeholder="Enter username"> <br><br>
                <input type="email" class="bcinput" name="email" placeholder="Enter your email"> <br><br>
                <input type="phone" class="bcinput" name="phone" placeholder="Enter your mobile number"> <br><br>
